      ...
      <div className="section-card">
        <div className="field-grid">
          ...
          <div>
            ...
            <input
              value={design.personalization.nameLine1}
              onChange={(event) => onUpdate("personalization.nameLine1", event.target.value)}
            />
          </div>
          <div>
            <label>Name Line 2</label>
            <input
              value={design.personalization.nameLine2}
              onChange={(event) => onUpdate("personalization.nameLine2", event.target.value)}
            />
          </div>
          <div>
